...
export const TypeUserCheck = () => (req,res,next) => {
    ...
    if(user.typeUser === "admin" || user.typeUser === "owner"){
...
const storage = multer.diskStorage({
    ...
    destination: (req,file,cb) => {
        ...
        if(typeFile === "images"){
            cb(null, _Dirname + '/src/public/clubs/'+ req.user.id + "/courts/" +req.params.court_title +'/images');
        }
        if(typeFile === "videos"){
            cb(null, _Dirname + '/src/public/clubs/'+ req.user.id + "/courts/" +req.params.court_title +'/videos');
        }
        if(typeFile === "documents"){
            cb(null, _Dirname + '/src/public/clubs/'+ req.user.id + "/courts/" +req.params.court_title +'/documents');
        }
